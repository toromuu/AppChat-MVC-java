...
public abstract class FactoriaDAO {
	...
	public static final String DAO_AppChat = "persistencia.AppChatFactoriaDAO";
	...
	public static FactoriaDAO getInstancia() throws DAOException{
			if (unicaInstancia == null) return getInstancia (FactoriaDAO.DAO_AppChat);
	...
	public abstract IAdaptadorGrupo getGrupoDAO();
